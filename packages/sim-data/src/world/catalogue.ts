...
export interface ClubSeed {
  ...
  /** Thuisshirt-patroon: "stripes" (verticale strepen), "centre" (middenstreep)
   *  of weglaten voor effen. Benader het echte clubshirt. */
    ...
    divisions: [
      {
        ...
        clubs: [
          ...
          { name: "Newcastle Magpies", short: "NEW", city: "Newcastle", strength: 0.80, colors: ["#ffffff", "#241f20"], pattern: "stripes" },
          ...
          { name: "Brighten", short: "BRI", city: "Brighton", strength: 0.71, colors: ["#0057b8", "#ffffff"], pattern: "stripes" },
          { name: "Crystal Palas", short: "CRY", city: "Londen", strength: 0.66, colors: ["#c4122e", "#1b458f"], pattern: "stripes" },
      ...
      },
      {
        ...
        clubs: [
          ...
          { name: "Sheffield Unite", short: "SHU", city: "Sheffield", strength: 0.53, colors: ["#ee2737", "#ffffff"], pattern: "stripes" },
          { name: "Middlesborough", short: "MID", city: "Middlesbrough", strength: 0.52, colors: ["#d71920", "#ffffff"] },
          { name: "West Bromwick", short: "WBA", city: "West Bromwich", strength: 0.51, colors: ["#091453", "#ffffff"], pattern: "stripes" },
          { name: "Coventree City", short: "COV", city: "Coventry", strength: 0.50, colors: ["#6cabdd", "#ffffff"] },
          { name: "Sunderlund", short: "SUN", city: "Sunderland", strength: 0.50, colors: ["#eb172b", "#ffffff"], pattern: "stripes" },
    ...
    divisions: [
      {
        ...
        relegation: 3,
        clubs: [
          { name: "Paris Saint-Germond", short: "PSG", city: "Parijs", strength: 0.94, colors: ["#004170", "#da291c"], pattern: "centre" },
    ...
    divisions: [
      {
        ...
        relegation: 3,
        clubs: [
          { name: "Juvextus", short: "JUV", city: "Turijn", strength: 0.86, colors: ["#ffffff", "#000000"], pattern: "stripes" },
          { name: "Internazio", short: "INT", city: "Milaan", strength: 0.90, colors: ["#0b1f8f", "#000000"], pattern: "stripes" },
          { name: "AC Milano", short: "MIL", city: "Milaan", strength: 0.85, colors: ["#fb090b", "#000000"], pattern: "stripes" },
          ...
          { name: "Atalanta Dea", short: "ATA", city: "Bergamo", strength: 0.80, colors: ["#1e71b8", "#000000"], pattern: "stripes" },
          { name: "Fiorentyna", short: "FIO", city: "Florence", strength: 0.70, colors: ["#592c82", "#ffffff"] },
          { name: "Bolonia", short: "BOL", city: "Bologna", strength: 0.69, colors: ["#a21c25", "#1a2d5e"], pattern: "stripes" },
          { name: "Torrino", short: "TOR", city: "Turijn", strength: 0.62, colors: ["#881420", "#ffffff"] },
          { name: "Udinesa", short: "UDI", city: "Udine", strength: 0.58, colors: ["#ffffff", "#000000"], pattern: "stripes" },
          { name: "Genoa Grifone", short: "GEN", city: "Genua", strength: 0.56, colors: ["#a21c25", "#1a2d5e"], pattern: "stripes" },
      ...
      },
      {
        ...
        clubs: [
          ...
          { name: "Cremonesa", short: "CRE", city: "Cremona", strength: 0.52, colors: ["#a21c25", "#8a8d8f"], pattern: "stripes" },
          ...
          { name: "Pisa Nerazzura", short: "PIS", city: "Pisa", strength: 0.48, colors: ["#1a2d5e", "#000000"], pattern: "stripes" },
          { name: "Sassolo", short: "SAS", city: "Sassuolo", strength: 0.50, colors: ["#00a14b", "#000000"], pattern: "stripes" },
    ...
    divisions: [
      {
        ...
        clubs: [
          ...
          { name: "Barcedona", short: "BAR", city: "Barcelona", strength: 0.92, colors: ["#a50044", "#004d98"], pattern: "stripes" },
          { name: "Atletra Madrid", short: "ATM", city: "Madrid", strength: 0.86, colors: ["#cb3524", "#ffffff"], pattern: "stripes" },
          { name: "Athletro Bilbao", short: "ATH", city: "Bilbao", strength: 0.76, colors: ["#ee2523", "#ffffff"], pattern: "stripes" },
          { name: "Real Sociedat", short: "RSO", city: "San Sebastián", strength: 0.74, colors: ["#0067b1", "#ffffff"], pattern: "stripes" },
          ...
          { name: "Rayo Vallecana", short: "RAY", city: "Madrid", strength: 0.53, colors: ["#ffffff", "#e53027"], pattern: "centre" },
      ...
      },
      {
        ...
        relegation: 0,
        clubs: [
          { name: "Esponyol", short: "ESP", city: "Barcelona", strength: 0.56, colors: ["#007fc8", "#ffffff"], pattern: "stripes" },
          { name: "Real Vallodolid", short: "VLL", city: "Valladolid", strength: 0.54, colors: ["#921c7a", "#ffffff"], pattern: "stripes" },
          { name: "Deportiva Coruna", short: "DEP", city: "A Coruña", strength: 0.53, colors: ["#0067b1", "#ffffff"], pattern: "stripes" },
          { name: "Sporting Gijonn", short: "SPG", city: "Gijón", strength: 0.52, colors: ["#d4011d", "#ffffff"], pattern: "stripes" },
          ...
          { name: "Almeria UD", short: "ALM", city: "Almería", strength: 0.49, colors: ["#d4011d", "#ffffff"], pattern: "stripes" },
          { name: "Granado CF", short: "GRA", city: "Granada", strength: 0.48, colors: ["#d4011d", "#ffffff"], pattern: "stripes" },
          { name: "Cadyz", short: "CAD", city: "Cádiz", strength: 0.47, colors: ["#fde100", "#005bac"] },
          { name: "Malaga CF", short: "MAL", city: "Málaga", strength: 0.46, colors: ["#005bac", "#ffffff"], pattern: "stripes" },
          { name: "Racing Santandar", short: "RAC", city: "Santander", strength: 0.45, colors: ["#00954c", "#ffffff"], pattern: "stripes" },
          { name: "Oviedra", short: "OVI", city: "Oviedo", strength: 0.44, colors: ["#005bac", "#ffffff"] },
          { name: "Huesco", short: "HUE", city: "Huesca", strength: 0.43, colors: ["#005bac", "#d4011d"], pattern: "stripes" },
          { name: "Elcha CF", short: "ELC", city: "Elche", strength: 0.42, colors: ["#ffffff", "#00954c"], pattern: "centre" },
          { name: "Burgas CF", short: "BUR", city: "Burgos", strength: 0.41, colors: ["#000000", "#ffffff"] },
          { name: "Eldenze", short: "ELD", city: "Elda", strength: 0.39, colors: ["#005bac", "#d4011d"], pattern: "stripes" },
        ],
      },
    ],
  },
    ...
    divisions: [
      {
        ...
        relegation: 3,
        clubs: [
          { name: "Ajacks", short: "AJA", city: "Amsterdam", strength: 0.84, colors: ["#ffffff", "#d2122e"], pattern: "centre" },
          ...
          { name: "Spartoo Rotterdam", short: "SPA", city: "Rotterdam", strength: 0.58, colors: ["#ffffff", "#e30613"], pattern: "centre" },
